        ...
        <div class="row justify-content-center">
            ...
            <div class="card o-hidden border-0 shadow-lg my-5">
                ...
                <div class="text-center">
                    <h2 class="h4 text-gray-900 mb-4">Weighing Bridge Application</h2>
                </div>
                <div class="row">
                ...
                <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                    <input id="username" type="text" class="form-control form-control-user" name="username" value="{{ old('username') }}">
